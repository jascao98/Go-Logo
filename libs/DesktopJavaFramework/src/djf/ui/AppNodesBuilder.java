...
public class AppNodesBuilder {
    ...
    public FlowPane buildFlowPane(Object nodeId,
            Pane parentPane,
            ToolBar parentToolBar,
            String styleClass,
            boolean usesKeyHandler,
        ...
        initNode(nodeId, flowPane, parentPane, parentToolBar, styleClass, usesKeyHandler, focusTraversable, enabled);
        return flowPane;
    }
    
    
    
    //self made border pane
